...
class ViewPhaseComponent extends Component {
    ...
    editPhase(id) {
        //:nthis.props.history.push(`/AddPhase/${id}`);
    ...
    render() {
        ...
        return (
            <div>
                ...
                <button className="btn btn-success" onClick={this.retour.bind(this)} style={{ marginLeft: "100px" }}>Retour</button>
                <button style={{ marginLeft: "100px" }} onClick={() => this.editPhase(phase.id)} className="btn btn-info">Update</button>
                </center>
